...
express.Router() is like a mini Express app you use to group related routes.
You put, say, all user endpoints in routes/users.js, add any user-specific middleware there, and then mount it once: app.use('/api/v1/user', userRouter).
